...
function Footer() {
    return (
        <>
            <div className="grid grid-cols-1 md:grid-cols-4 items-center text-center gap-5 md:gap-0 border-t-2 border-[#cd9232bb] rounded-lg lg:rounded-[50px] py-4 mt-10 text-black">
                <Link
                    to={"/"}
            ...
            <p className="text-center">
                &copy; All rights reserved for Dish Dish. Copyright 2024
            </p>
        </>
    );
}
